                ...
                <div class="form-content">
                    <div class="form-items">
                        <div class="website-logo-inside">
                            <a href="../index.php">
                                <div>
                                    <img class="logo-size" src="images/logo1.png" width="200px">
                                </div>
                            </a>
                        </div>
                        ...
                        <form name="registration" method="post" action="" enctype="multipart/form-data">
                            <input class="form-control" type="text" name="fname" placeholder="Fisrt Name" required>
                            ...
                            <div class="form-button">
                                <button id="submit" type="submit" class="ibtn" name="signup"  value="Sign Up" >Register</button>
                            </div>
                        </form>
